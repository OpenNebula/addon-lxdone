...
## 1.1 Observations & Recommendations
- **LXDoNe** has been tested in **Ubuntu 16.04** using **OpenNebula 5.2** in both the ***frontend*** and the ***virtualization nodes***, other linux distributions or **OpenNebula** version below **5** are not guaranteed to work proper.
...
- Access to [LXD image repository](https://images.linuxcontainers.org/images) is required for some container creation methods
...
## 1.5 Start OpenNebula
```
# systemctl start opennebula-novnc opennebula opennebula-sunstone opennebula-scheduler
```
...
# 4 - Sunstone
This is a set of basic usage, there are lots of extra features to use.

## 4.1 Image Upload 

Upload the Virtual Appliance to OpenNebula. You can alternatively use the **LXDoNe** virtual appliance in the ***MarketPlace***
